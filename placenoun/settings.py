# Django settings for placenoun project.
...
try:
  from site_settings import INTERNAL_IPS
except ImportError:
...
try:
  from site_settings import MEDIA_ROOT
except ImportError:
  MEDIA_ROOT = ''
...
SECRET_KEY = 'f9_g5&i^0%k&kq56iy#k^c1jqqh4y1m5h$d2(*^rat+gp&cjpl'
